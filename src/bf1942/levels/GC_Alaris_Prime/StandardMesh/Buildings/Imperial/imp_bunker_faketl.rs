subshader "imp_bunker_faketl_Material0" "StandardMesh/Default"
{
	lighting false;
...
subshader "imp_bunker_faketl_Material1" "StandardMesh/Default"
{
	lighting false;
	lightingSpecular false;
...
subshader "imp_bunker_faketl_Material2" "StandardMesh/Default"
{
	lighting false;
	lightingSpecular false;
